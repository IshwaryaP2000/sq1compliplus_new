...
const AssessmentView = () => {
  ...
  //   const selectedQusIds = Object.keys(checkedItems).filter(
  //     (key) => checkedItems[key]
  //   );

  //   const payload = {
  //     email: selectedEmails.map((email) => email.value),
  //     qus_ids: selectedQusIds.map((id) => parseInt(id)),
  //   };
  ...
  const getCount = async () => {
    console.log("checking handleSubmitStore");
    try {
              ...
              <tbody className="tablescrolling-tbody">
                <tr>
                  ...
                  <td className="text-center text-secondary">
                    ...
                    >
                      {" "}
                      <i className="fa-regular  fs-5 p-2 bg-light rounded-circle fa-folder-open view-evidence-open-icon"></i>{" "}
                    </button>
                  </td>
                </tr>
                <tr>
